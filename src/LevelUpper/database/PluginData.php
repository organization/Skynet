...
class PluginData {
	...
	public function initDatabase() {
		$this->databaseUpdate ( "pluginDB.json" );
	 ...
	 * @param string $targetYmlName        	
	 */
	public function databaseUpdate($targetYmlName) {
		$targetYml = (new Config ( $this->getPlugin ()->getDataFolder () . $targetYmlName, Config::JSON ))->getAll ();
		if (! isset ( $targetYml ["m_version"] )) {
			$this->getPlugin ()->saveResource ( $targetYmlName, true );
		} else if ($targetYml ["db_version"] < $this->db_version) {
			$this->getPlugin ()->saveResource ( $targetYmlName, true );
		}
	}
	/**
